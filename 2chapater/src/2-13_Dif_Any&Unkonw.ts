...
// let data:any=undefined // null undefined

// let data: any = ["ab", "df"]
// let num: number = data // 不报错  any 任何类的父类也可以是任何类的子类

// let data: unknown = ["ab", "df"]
// let num: number = data // 报错  unknown 不可以以是任何类的子类



// any 类型的变量可以获取任意名称的属性和任意名称的方法
...
//   console.log(data[0]) // 报错
//   console.log(data.name) // 报错
// }

getData({ name: "wangwu", age: 23 })
getData([3, 4])
export {}
...
// Vue3 源码片段any的应用场景--自定义守卫中使用 any
// export function isRef(r: any): r is Ref {
//   return Boolean(r && r._v_isRef === true) // any类型的 r 参数在函数内部获取属性
// }
